...
import { UpdateProductRequest, Product } from "@/types/lib";

const PINK = "#FF69B4";
const LIGHT_GRAY = "#F7F7F7";
const DARK_GRAY = "#333333";

// Mock de um produto existente
const mockProduct: Product = {
    id: "1",
    name: "Bolo de Chocolate",
    price: 45.0,
    description: "Delicioso bolo de chocolate com cobertura cremosa de brigadeiro.",
...
export default function ProductEditScreen() {
  ...
  useEffect(() => {
    // Em um app real, você buscaria os dados do produto na API usando o 'id'
    console.log("Carregando dados do produto com ID:", id);
    setName(mockProduct.name);
    setDescription(mockProduct.description);
    setPrice(mockProduct.price.toString().replace(".", ","));
    setImageUrl(mockProduct.imageUrl);
    setIsActive(mockProduct.isActive);
  }, [id]);
